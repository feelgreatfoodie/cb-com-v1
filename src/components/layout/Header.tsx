      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="glass absolute right-0 top-full z-50 mt-2 w-64 overflow-hidden rounded-xl p-2 shadow-2xl"
          >
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="font-mono text-[10px] tracking-wider text-foreground/40 transition-colors hover:text-accent"
